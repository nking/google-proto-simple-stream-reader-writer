...
public class PBStreamWriter {
    ...
    /**
     * write generatedMessages to the given output stream by writing a websocket style byte marker that includes
     * the next event length and write the next encoded serialized event, repeating for list of events
     * 
     * @param out
